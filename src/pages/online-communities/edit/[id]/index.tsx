...
import { getOnlineCommunityById, updateOnlineCommunityById } from 'apiSdk/online-communities';
...
function OnlineCommunityEditPage() {
  ...
  const handleSubmit = async (values: OnlineCommunityInterface, { resetForm }: FormikHelpers<any>) => {
    setFormError(null);
    try {
      const updated = await updateOnlineCommunityById(id, values);
      mutate(updated);
      resetForm();
