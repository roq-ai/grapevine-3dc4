...
import { getLeadOpportunityById, updateLeadOpportunityById } from 'apiSdk/lead-opportunities';
...
function LeadOpportunityEditPage() {
  ...
  const handleSubmit = async (values: LeadOpportunityInterface, { resetForm }: FormikHelpers<any>) => {
    setFormError(null);
    try {
      const updated = await updateLeadOpportunityById(id, values);
      mutate(updated);
      resetForm();
